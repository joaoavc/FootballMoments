...
class ImageResize {
    ...
    private function crop($optimalWidth, $optimalHeight, $newWidth, $newHeight) {
        ...
        imagecopyresampled(
                $this->imageResized, $crop, 0, 0, $cropStartX, $cropStartY, $newWidth, $newHeight, $newWidth, $newHeight);
    }
    ...
    public function resizeImage($newWidth, $newHeight, $option = "auto") {
        ...
        imagecopyresampled(
                $this->imageResized, $this->image, 0, 0, 0, 0, $optimalWidth, $optimalHeight, $this->width, $this->height);
